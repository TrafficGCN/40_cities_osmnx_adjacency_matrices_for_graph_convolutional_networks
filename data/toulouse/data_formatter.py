...
df = pd.read_csv(OS_PATH + '/data/toulouse/utd19_u_toulouse.csv')
...
pivot_df.to_csv(OS_PATH + '/data/toulouse/utd19_u_toulouse_speed.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/toulouse/utd19_u_toulouse_flow.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/toulouse/utd19_u_toulouse_occ.csv', index=False)