...
df = pd.read_csv(OS_PATH + '/data/manchester/utd19_u_manchester.csv')
...
pivot_df.to_csv(OS_PATH + '/data/manchester/utd19_u_manchester_speed.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/manchester/utd19_u_manchester_flow.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/manchester/utd19_u_manchester_occ.csv', index=False)