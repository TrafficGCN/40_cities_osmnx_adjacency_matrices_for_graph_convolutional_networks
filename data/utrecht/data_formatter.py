...
df = pd.read_csv(OS_PATH + '/data/utrecht/utd19_u_utrecht.csv')
...
pivot_df.to_csv(OS_PATH + '/data/utrecht/utd19_u_utrecht_speed.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/utrecht/utd19_u_utrecht_flow.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/utrecht/utd19_u_utrecht_occ.csv', index=False)