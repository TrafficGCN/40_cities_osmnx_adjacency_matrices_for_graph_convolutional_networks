...
df = pd.read_csv(OS_PATH + '/data/bern/utd19_u_bern.csv')
...
pivot_df.to_csv(OS_PATH + '/data/bern/utd19_u_bern_speed.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/bern/utd19_u_bern_flow.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/bern/utd19_u_bern_occ.csv', index=False)