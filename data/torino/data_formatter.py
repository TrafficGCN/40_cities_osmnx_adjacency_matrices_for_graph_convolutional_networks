...
df = pd.read_csv(OS_PATH + '/data/torino/utd19_u_torino.csv')
...
pivot_df.to_csv(OS_PATH + '/data/torino/utd19_u_torino_speed.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/torino/utd19_u_torino_flow.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/torino/utd19_u_torino_occ.csv', index=False)