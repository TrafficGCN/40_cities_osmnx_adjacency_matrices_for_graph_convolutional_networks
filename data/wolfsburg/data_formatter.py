...
df = pd.read_csv(OS_PATH + '/data/wolfsburg/utd19_u_wolfsburg.csv')
...
pivot_df.to_csv(OS_PATH + '/data/wolfsburg/utd19_u_wolfsburg_speed.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/wolfsburg/utd19_u_wolfsburg_flow.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/wolfsburg/utd19_u_wolfsburg_occ.csv', index=False)