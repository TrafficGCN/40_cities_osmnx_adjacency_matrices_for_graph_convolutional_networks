...
split_csv_three_parts(OS_PATH + '/data/hamburg/utd19_u_hamburg_speed.csv', OS_PATH +  '/data/hamburg/utd19_u_hamburg_speed_part1.csv', OS_PATH +  '/data/hamburg/utd19_u_hamburg_speed_part2.csv', OS_PATH +  '/data/hamburg/utd19_u_hamburg_speed_part3.csv')
split_csv_three_parts(OS_PATH + '/data/hamburg/utd19_u_hamburg_flow.csv', OS_PATH +  '/data/hamburg/utd19_u_hamburg_flow_part1.csv', OS_PATH +  '/data/hamburg/utd19_u_hamburg_flow_part2.csv', OS_PATH +  '/data/hamburg/utd19_u_hamburg_flow_part3.csv')
split_csv_three_parts(OS_PATH + '/data/hamburg/utd19_u_hamburg_occ.csv', OS_PATH +  '/data/hamburg/utd19_u_hamburg_occ_part1.csv', OS_PATH +  '/data/hamburg/utd19_u_hamburg_occ_part2.csv', OS_PATH +  '/data/hamburg/utd19_u_hamburg_occ_part3.csv')
