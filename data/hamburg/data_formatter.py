...
df = pd.read_csv(OS_PATH + '/data/hamburg/utd19_u_hamburg.csv')
...
pivot_df.to_csv(OS_PATH + '/data/hamburg/utd19_u_hamburg_speed.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/hamburg/utd19_u_hamburg_flow.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/hamburg/utd19_u_hamburg_occ.csv', index=False)