...
df = pd.read_csv(OS_PATH + '/data/birmingham/utd19_u_birmingham.csv')
...
pivot_df.to_csv(OS_PATH + '/data/birmingham/utd19_u_birmingham_speed.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/birmingham/utd19_u_birmingham_flow.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/birmingham/utd19_u_birmingham_occ.csv', index=False)