...
df = pd.read_csv(OS_PATH + '/data/augsburg/utd19_u_augsburg.csv')
...
pivot_df.to_csv(OS_PATH + '/data/augsburg/utd19_u_augsburg_speed.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/augsburg/utd19_u_augsburg_flow.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/augsburg/utd19_u_augsburg_occ.csv', index=False)