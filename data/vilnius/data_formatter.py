...
df = pd.read_csv(OS_PATH + '/data/vilnius/utd19_u_vilnius.csv')
...
pivot_df.to_csv(OS_PATH + '/data/vilnius/utd19_u_vilnius_speed.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/vilnius/utd19_u_vilnius_flow.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/vilnius/utd19_u_vilnius_occ.csv', index=False)