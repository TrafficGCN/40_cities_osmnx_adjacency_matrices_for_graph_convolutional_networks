...
df = pd.read_csv(OS_PATH + '/data/zurich/utd19_u_zurich.csv')
...
pivot_df.to_csv(OS_PATH + '/data/zurich/utd19_u_zurich_speed.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/zurich/utd19_u_zurich_flow.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/zurich/utd19_u_zurich_occ.csv', index=False)