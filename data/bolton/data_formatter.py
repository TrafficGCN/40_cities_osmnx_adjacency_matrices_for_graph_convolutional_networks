...
df = pd.read_csv(OS_PATH + '/data/bolton/utd19_u_bolton.csv')
...
pivot_df.to_csv(OS_PATH + '/data/bolton/utd19_u_bolton_speed.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/bolton/utd19_u_bolton_flow.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/bolton/utd19_u_bolton_occ.csv', index=False)