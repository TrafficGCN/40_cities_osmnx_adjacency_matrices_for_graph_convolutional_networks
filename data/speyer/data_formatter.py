...
df = pd.read_csv(OS_PATH + '/data/speyer/utd19_u_speyer.csv')
...
pivot_df.to_csv(OS_PATH + '/data/speyer/utd19_u_speyer_speed.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/speyer/utd19_u_speyer_flow.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/speyer/utd19_u_speyer_occ.csv', index=False)