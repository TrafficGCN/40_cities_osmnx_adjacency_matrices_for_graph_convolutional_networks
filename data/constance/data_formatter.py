...
df = pd.read_csv(OS_PATH + '/data/constance/utd19_u_constance.csv')
...
pivot_df.to_csv(OS_PATH + '/data/constance/utd19_u_constance_speed.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/constance/utd19_u_constance_flow.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/constance/utd19_u_constance_occ.csv', index=False)