...
df = pd.read_csv(OS_PATH + '/data/paris/utd19_u_paris.csv')
...
pivot_df.to_csv(OS_PATH + '/data/paris/utd19_u_paris_speed.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/paris/utd19_u_paris_flow.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/paris/utd19_u_paris_occ.csv', index=False)