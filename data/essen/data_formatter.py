...
df = pd.read_csv(OS_PATH + '/data/essen/utd19_u_essen.csv')
...
pivot_df.to_csv(OS_PATH + '/data/essen/utd19_u_essen_speed.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/essen/utd19_u_essen_flow.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/essen/utd19_u_essen_occ.csv', index=False)