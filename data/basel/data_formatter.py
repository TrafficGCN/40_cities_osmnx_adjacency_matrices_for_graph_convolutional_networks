...
df = pd.read_csv(OS_PATH + '/data/basel/utd19_u_basel.csv')
...
pivot_df.to_csv(OS_PATH + '/data/basel/utd19_u_basel_speed.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/basel/utd19_u_basel_flow.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/basel/utd19_u_basel_occ.csv', index=False)