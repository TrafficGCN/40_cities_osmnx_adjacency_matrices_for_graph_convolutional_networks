...
df = pd.read_csv(OS_PATH + '/data/stuttgart/utd19_u_stuttgart.csv')
...
pivot_df.to_csv(OS_PATH + '/data/stuttgart/utd19_u_stuttgart_speed.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/stuttgart/utd19_u_stuttgart_flow.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/stuttgart/utd19_u_stuttgart_occ.csv', index=False)