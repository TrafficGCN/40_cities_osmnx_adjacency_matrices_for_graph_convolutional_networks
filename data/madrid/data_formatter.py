...
df = pd.read_csv(OS_PATH + '/data/madrid/utd19_u_madrid.csv')
...
pivot_df.to_csv(OS_PATH + '/data/madrid/utd19_u_madrid_speed.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/madrid/utd19_u_madrid_occ.csv', index=False)