...
df = pd.read_csv(OS_PATH + '/data/toronto/utd19_u_toronto.csv')
...
pivot_df.to_csv(OS_PATH + '/data/toronto/utd19_u_toronto_speed.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/toronto/utd19_u_toronto_flow.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/toronto/utd19_u_toronto_occ.csv', index=False)