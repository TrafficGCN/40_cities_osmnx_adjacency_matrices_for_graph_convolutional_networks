...
df = pd.read_csv(OS_PATH + '/data/marseille/utd19_u_marseille.csv')
...
pivot_df.to_csv(OS_PATH + '/data/marseille/utd19_u_marseille_speed.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/marseille/utd19_u_marseille_flow.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/marseille/utd19_u_marseille_occ.csv', index=False)