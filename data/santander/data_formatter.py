...
df = pd.read_csv(OS_PATH + '/data/santander/utd19_u_santander.csv')
...
pivot_df.to_csv(OS_PATH + '/data/santander/utd19_u_santander_speed.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/santander/utd19_u_santander_flow.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/santander/utd19_u_santander_occ.csv', index=False)