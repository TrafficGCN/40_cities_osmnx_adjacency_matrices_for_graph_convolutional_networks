...
df = pd.read_csv(OS_PATH + '/data/losangeles/utd19_u_losangeles.csv')
...
pivot_df.to_csv(OS_PATH + '/data/losangeles/utd19_u_losangeles_speed.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/losangeles/utd19_u_losangeles_flow.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/losangeles/utd19_u_losangeles_occ.csv', index=False)