...
df = pd.read_csv(OS_PATH + '/data/melbourne/utd19_u_melbourne.csv')
...
pivot_df.to_csv(OS_PATH + '/data/melbourne/utd19_u_melbourne_speed.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/melbourne/utd19_u_melbourne_flow.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/melbourne/utd19_u_melbourne_occ.csv', index=False)