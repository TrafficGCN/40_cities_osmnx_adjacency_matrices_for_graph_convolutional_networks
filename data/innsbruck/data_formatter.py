...
df = pd.read_csv(OS_PATH + '/data/innsbruck/utd19_u_innsbruck.csv')
...
pivot_df.to_csv(OS_PATH + '/data/innsbruck/utd19_u_innsbruck_speed.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/innsbruck/utd19_u_innsbruck_flow.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/innsbruck/utd19_u_innsbruck_occ.csv', index=False)