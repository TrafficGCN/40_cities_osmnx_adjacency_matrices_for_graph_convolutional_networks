...
df = pd.read_csv(OS_PATH + '/data/rotterdam/utd19_u_rotterdam.csv')
...
pivot_df.to_csv(OS_PATH + '/data/rotterdam/utd19_u_rotterdam_speed.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/rotterdam/utd19_u_rotterdam_flow.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/rotterdam/utd19_u_rotterdam_occ.csv', index=False)