...
df = pd.read_csv(OS_PATH + '/data/bordeaux/utd19_u_bordeaux.csv')
...
pivot_df.to_csv(OS_PATH + '/data/bordeaux/utd19_u_bordeaux_speed.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/bordeaux/utd19_u_bordeaux_flow.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/bordeaux/utd19_u_bordeaux_occ.csv', index=False)