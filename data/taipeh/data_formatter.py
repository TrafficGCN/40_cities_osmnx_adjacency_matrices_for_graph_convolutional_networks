...
df = pd.read_csv(OS_PATH + '/data/taipeh/utd19_u_taipeh.csv')
...
pivot_df.to_csv(OS_PATH + '/data/taipeh/utd19_u_taipeh_speed.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/taipeh/utd19_u_taipeh_flow.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/taipeh/utd19_u_taipeh_occ.csv', index=False)