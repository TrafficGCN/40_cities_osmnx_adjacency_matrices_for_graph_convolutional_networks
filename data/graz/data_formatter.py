...
df = pd.read_csv(OS_PATH + '/data/graz/utd19_u_graz.csv')
...
pivot_df.to_csv(OS_PATH + '/data/graz/utd19_u_graz_speed.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/graz/utd19_u_graz_flow.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/graz/utd19_u_graz_occ.csv', index=False)