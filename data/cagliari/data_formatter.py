...
df = pd.read_csv(OS_PATH + '/data/cagliari/utd19_u_cagliari.csv')
...
pivot_df.to_csv(OS_PATH + '/data/cagliari/utd19_u_cagliari_speed.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/cagliari/utd19_u_cagliari_flow.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/cagliari/utd19_u_cagliari_occ.csv', index=False)