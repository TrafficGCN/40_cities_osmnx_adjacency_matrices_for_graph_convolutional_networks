...
df = pd.read_csv(OS_PATH + '/data/frankfurt/utd19_u_frankfurt.csv')
...
pivot_df.to_csv(OS_PATH + '/data/frankfurt/utd19_u_frankfurt_speed.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/frankfurt/utd19_u_frankfurt_flow.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/frankfurt/utd19_u_frankfurt_occ.csv', index=False)