...
df = pd.read_csv(OS_PATH + '/data/munich/utd19_u_munich.csv')
...
pivot_df.to_csv(OS_PATH + '/data/munich/utd19_u_munich_speed.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/munich/utd19_u_munich_flow.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/munich/utd19_u_munich_occ.csv', index=False)