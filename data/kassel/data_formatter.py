...
df = pd.read_csv(OS_PATH + '/data/kassel/utd19_u_kassel.csv')
...
pivot_df.to_csv(OS_PATH + '/data/kassel/utd19_u_kassel_speed.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/kassel/utd19_u_kassel_flow.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/kassel/utd19_u_kassel_occ.csv', index=False)