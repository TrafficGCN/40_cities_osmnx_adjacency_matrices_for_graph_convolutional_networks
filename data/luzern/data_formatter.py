...
df = pd.read_csv(OS_PATH + '/data/luzern/utd19_u_luzern.csv')
...
pivot_df.to_csv(OS_PATH + '/data/luzern/utd19_u_luzern_speed.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/luzern/utd19_u_luzern_flow.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/luzern/utd19_u_luzern_occ.csv', index=False)