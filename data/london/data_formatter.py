...
df = pd.read_csv(OS_PATH + '/data/london/utd19_u_london.csv')
...
pivot_df.to_csv(OS_PATH + '/data/london/utd19_u_london_speed.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/london/utd19_u_london_flow.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/london/utd19_u_london_occ.csv', index=False)