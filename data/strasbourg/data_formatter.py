...
df = pd.read_csv(OS_PATH + '/data/strasbourg/utd19_u_strasbourg.csv')
...
pivot_df.to_csv(OS_PATH + '/data/strasbourg/utd19_u_strasbourg_speed.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/strasbourg/utd19_u_strasbourg_flow.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/strasbourg/utd19_u_strasbourg_occ.csv', index=False)