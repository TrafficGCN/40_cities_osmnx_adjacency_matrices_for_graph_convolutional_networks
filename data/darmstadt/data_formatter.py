...
df = pd.read_csv(OS_PATH + '/data/darmstadt/utd19_u_darmstadt.csv')
...
pivot_df.to_csv(OS_PATH + '/data/darmstadt/utd19_u_darmstadt_speed.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/darmstadt/utd19_u_darmstadt_flow.csv', index=False)
...
# Saving the DataFrame to a new CSV file
pivot_df.to_csv(OS_PATH + '/data/darmstadt/utd19_u_darmstadt_occ.csv', index=False)